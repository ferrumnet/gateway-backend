...
module.exports = function (router) {
    ...
    router.get('reset/stepFlow/:id', async (req, res) => {
        ...
        if(stepFlowStepsHistory.length){
            ...
            return res.http400('user as no stepFlowStepsHistory for specified stepflow to reset');
