...
const { db, asyncMiddleware, commonFunctions, stringHelper, raisePoolsHelper } = global
const mailer = global.mailer;
var mongoose = require('mongoose');

module.exports = function (router) {

  router.post('/pledge/:id', asyncMiddleware(async (req, res) => {
  ...
  router.get('/is/pledged/:id', asyncMiddleware(async (req, res) => {
  ...
  router.get('/pledged/:id', asyncMiddleware(async (req, res) => {
  ...
  router.get('/all/pledged', asyncMiddleware(async (req, res) => {
