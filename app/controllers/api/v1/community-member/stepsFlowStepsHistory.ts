...
module.exports = function (router: any) {
    ...
    router.get('/stepFlow/:id', async (req: any, res: any) => {
        ...
        if(!stepFlowStepsHistory.length){
            ...
            if(StepsFlowItem){
                ...
                for(let StepsFlow of StepsFlowItem.stepFlowSteps){
                    let stepFlowStep = await db.StepFlowSteps.findOne({_id: StepsFlow })
    ...
    router.get('/stepFlow/latest/:id', async (req: any, res: any) => {
      let sequence = 0
        let stepFlowStepsHistory = []
    ...
    router.get('/restart/stepFlow/:id', async (req: any, res: any) => {
