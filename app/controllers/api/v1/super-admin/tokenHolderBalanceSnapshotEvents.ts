...
module.exports = function (router: any) {
  ...
  router.post("/create", asyncMiddleware(async (req: any, res: any) => {
    ...
    if (!req.body.type || !req.body.triggeredSnapshotDateTime || !req.body.leaderboard|| !req.body.organization) {
      return res.http400('type & triggeredSnapshotDateTime & leaderboard & organization are required');
    }
