...
module.exports = function (router: any) {
  ...
  router.get('/blockNumberRange/verified/:verified', asyncMiddleware(async (req: any, res: any) => {
    let filter = {}
   ...
   let transactionsByContractAddress = await db.CompetitionTransactionsSnapshots.aggregate([ filter, {
      ...
      transactionsByContractAddress.forEach((record: any)=>{
  ...
  router.post('/blockNumbers/verify/byTokenContractAddress/:tokenContractAddress', asyncMiddleware(async (req: any, res: any) => { 
  ...
  router.post('/recaptureTransactions/byTokenContractAddress/:tokenContractAddress', asyncMiddleware(async (req: any, res: any) => { 
