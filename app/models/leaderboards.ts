...
var schema = mongoose.Schema(
  {
    ...
    leaderboardCurrencyAddressesByNetwork: [
      {
        type: mongoose.Schema.Types.ObjectId,
        ref: "leaderboardCurrencyAddressesByNetwork",
      },
    ],
    ...
    createdByUser: {
      ...
      ref: "users",
      required: true,
    }, // this key needs be replaced on all over the app. Right now key user is used on every where. So once this will replaced we will remove user from the model
    ...
    leaderboardStakingContractAddresses: [
      {
        type: mongoose.Schema.Types.ObjectId,
        ref: "stakingsContractsAddresses",
      },
    ],
    stakingContractAddresses: [],
    type: {
      type: String,
      enum: { values: ["stake", "other"], message: "Invalid type" },
      default: "other",
    },
