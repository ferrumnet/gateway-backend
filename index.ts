...
(
  global as any
).calcaluteGrowthVolume = require("./app/lib/middlewares/helpers/cronsHelpers/competitionGrowthCalculater");
(
  global as any
).mSLGCalculations = require("./app/lib/middlewares/helpers/cronsHelpers/multiStakingLeaderboardGrowthCalculator");
...
(
  global as any
).mSLGTrackerHelper = require("./app/lib/middlewares/helpers/multiStakingLeaderboardGrowthTrackerHelper");
(
  global as any
).CGTrackerHelper = require("./app/lib/middlewares/helpers/competitionGrowthTrackerHelper");
(
  global as any
).stakingTrackerHelper = require("./app/lib/middlewares/helpers/stakingTrackerHelper");
(
  global as any
).cTSnapshotHelper = require("./app/lib/middlewares/helpers/competitionTransactionsSnapshotHelper");
(
  global as any
).competitionHelper = require("./app/lib/middlewares/helpers/competitionHelper");
...
(
  global as any
).timeoutCallBack = require("./app/lib/middlewares/helpers/timeoutCallBack");
(global as any).helper = require("./app/lib/middlewares/helpers/dateHelper");
(
  global as any
).stringHelper = require("./app/lib/middlewares/helpers/stringHelper");
(
  global as any
).timeoutHelper = require("./app/lib/middlewares/helpers/timeoutHelper");
(
  global as any
).logsHelper = require("./app/lib/middlewares/helpers/logsHelper");
(
  global as any
).usersHelper = require("./app/lib/middlewares/helpers/usersHelper");
(
  global as any
).stakingHelper = require("./app/lib/middlewares/helpers/stakingHelper");
(
  global as any
).addressesHelper = require("./app/lib/middlewares/helpers/addressesHelper");
(
  global as any
...
(
  global as any
).raisePoolsHelper = require("./app/lib/middlewares/helpers/raisePoolsHelper");
(
  global as any
).organizationHelper = require("./app/lib/middlewares/helpers/organizationHelper");
(
  global as any
).leaderboardHelper = require("./app/lib/middlewares/helpers/leaderboardHelper");
(
  global as any
).tokenHolderBalanceSnapshotEventHelper = require("./app/lib/middlewares/helpers/tokenHolderBalanceSnapshotEventHelper");
(
  global as any
).currencyHelper = require("./app/lib/middlewares/helpers/currencyHelper");
(
  global as any
).crucibleAprsHelper = require("./app/lib/middlewares/helpers/crucibleAprsHelper");
(global as any).fetchCrucibleApr = require("./app/lib/crons/fetchCrucibleApr");
(
  global as any
).networksHelper = require("./app/lib/middlewares/helpers/networksHelper");
(
  global as any
).dexesHelper = require("./app/lib/middlewares/helpers/dexesHelper");
(
  global as any
).productsHelper = require("./app/lib/middlewares/helpers/productsHelper");
(
  global as any
).packagesHelper = require("./app/lib/middlewares/helpers/packagesHelper");
(
  global as any
...
(
  global as any
).contractHelper = require("./app/lib/middlewares/helpers/multiSwapHelpers/contractHelper");
(
  global as any
).signatureHelper = require("./app/lib/middlewares/helpers/multiSwapHelpers/signatureHelper");
(
  global as any
).swapTransactionHelper = require("./app/lib/middlewares/helpers/multiSwapHelpers/swapTransactionHelper");
(
  global as any
).ecdsaHelper = require("./app/lib/middlewares/helpers/multiSwapHelpers/ecdsaHelper");
(
  global as any
).addressFromPublicKeyHelper = require("./app/lib/middlewares/helpers/multiSwapHelpers/addressFromPublicKeyHelper");
(
  global as any
).swapUtilsHelper = require("./app/lib/middlewares/helpers/multiSwapHelpers/swapUtilsHelper");
(
  global as any
).standardStatuses = require("./app/lib/response/standardStatuses");
(
  global as any
).smartContractHelper = require("./app/lib/middlewares/helpers/smartContractHelper");
(
  global as any
).withdrawTransactionHelper = require("./app/lib/middlewares/helpers/multiSwapHelpers/withdrawTransactionHelper");
(
  global as any
